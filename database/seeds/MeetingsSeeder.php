    ...
    public function run()
    {
        ...
        $items = [
            ...
            [
                ...
                "description" => "盘丝岭专属奇遇需要门贡有几率触发", "times" => 0, "group" => "门派专属",
            ],
            [
                "official" => "", "level" => 0, "name" => "暗杀行动",
                "maps" => [["map" => "天魔里", "x" => 0, "y" => 0]],
                "description" => "天魔里专属奇遇不需要门贡，天魔里泽野有几率触发", "times" => 0, "group" => "门派专属",
            ],
            [
                "official" => "", "level" => 0, "name" => "碧月青莲",
                "maps" => [["map" => "南海普陀", "x" => 82, "y" => 65]],
                "description" => "南海普陀专属奇遇需要门贡，满足怪物入侵时有几率触发", "times" => 0, "group" => "门派专属",
            ],
            [
                "official" => "", "level" => 0, "name" => "医者仁心",
                "maps" => [["map" => "大唐国境", "x" => 82, "y" => 154]],
                "description" => "佛门专属奇遇需要门贡，丑时有几率触发", "times" => 2, "group" => "门派专属",
            ],
            [
                "official" => "", "level" => 0, "name" => "百兽之王",
                "maps" => [["map" => "万兽岭", "x" => 0, "y" => 0]],
                "description" => "万兽岭专属奇遇需要门贡，万兽岭有来有去有几率触发", "times" => 0, "group" => "门派专属",
            ],
            [
                "official" => "", "level" => 0, "name" => "雷霆天兵",
                "maps" => [["map" => "凌霄天宫", "x" => 0, "y" => 0]],
                "description" => "凌霄天宫专属奇遇需要门贡，凌霄天宫杨戬有几率触发", "times" => 0, "group" => "门派专属",
            ],
            [
                "official" => "", "level" => 0, "name" => "修葺寨门",
                "maps" => [["map" => "魔王山", "x" => 0, "y" => 0]],
                "description" => "魔王山专属奇遇需要门贡，魔王山平天大圣有几率触发", "times" => 0, "group" => "门派专属",
            ],
            [
                "official" => "", "level" => 0, "name" => "人参果",
                "maps" => [["map" => "镇元五庄", "x" => 30, "y" => 55]],
                "description" => "镇元五庄专属奇遇需要门贡", "times" => 0, "group" => "门派专属",
            ],
            [
                "official" => "", "level" => 0, "name" => "门派试炼",
                "maps" => [["map" => "七星方寸", "x" => 0, "y" => 0]],
                "description" => "七星方寸专属奇遇需要门贡，七星方寸大觉金仙有几率触发", "times" => 0, "group" => "门派专属",
            ],
            [
                "official" => "", "level" => 0, "name" => "将府往谈",
                "maps" => [["map" => "天策", "x" => 0, "y" => 0]],
                "description" => "天策专属奇遇需要门贡，天策程府管家有几率触发", "times" => 0, "group" => "门派专属",
            ],
            [
                "official" => "", "level" => 0, "name" => "东海疑踪",
                "maps" => [["map" => "东海龙宫", "x" => 0, "y" => 0]],
                "description" => "东海龙宫专属奇遇需要门贡，东海龙宫龟千岁有几率触发", "times" => 0, "group" => "门派专属",
            ],
            [
                "official" => "", "level" => 0, "name" => "见习鬼差",
                "maps" => [["map" => "幽冥地府", "x" => 0, "y" => 0]],
                "description" => "幽冥地府专属奇遇需要门贡，幽冥地府地藏菩萨触发，当前窗口说话无弹窗", "times" => 0, "group" => "门派专属",
            ],
            [
                "official" => "", "level" => 0, "name" => "身先士卒",
                "maps" => [["map" => "无名谷", "x" => 0, "y" => 0]],
                "description" => "无名谷专属奇遇需要门贡，御虚真人附近有几率触发", "times" => 0, "group" => "门派专属",
            ],
